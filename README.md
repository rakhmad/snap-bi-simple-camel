# SNAP BI Simple REST API

This project is a very simple rest API example for SNAP BI Backend. 
Build using Quarkus, with Camel for integration.
...
You can then execute your native executable with: `./target/snap-bi-poc-1.0.0-SNAPSHOT-runner`
...
- Camel REST OpenApi ([guide](https://access.redhat.com/documentation/en-us/red_hat_integration/2.latest/html/camel_extensions_for_quarkus_reference/extensions-rest-openapi)): Configure REST producers based on an OpenAPI specification document delegating to a component implementing the RestProducerFactory interface
